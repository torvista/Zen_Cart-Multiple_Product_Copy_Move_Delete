<?php //steve TO CHANGE SORT ORDER go to line 338, changed default selected radio button to Delete One, added id to checkbox, added labels to other tds to allow easier selection of checkbox by clicking text as well, added edit-product link to status icons, php warning
/**
 * @package admin
        ...
        <td width="100%" valign="top">
            <table border="0" width="100%" cellspacing="0" cellpadding="10">
                ...
                <?php if ($action == 'new') {//default / initial page entry
                    ...
                    echo zen_draw_radio_field('within',
                            'name') . '&nbsp;' . TEXT_NAME_ONLY . '&nbsp;' . zen_draw_radio_field('within', 'all',
                            'all') . '&nbsp;' . TEXT_DESCRIPTIONS . "<br>\n";
                    ...
                    echo TEXT_PRODUCTS_MANUFACTURER . zen_draw_pull_down_menu('manufacturer_id',
                            $manufacturers_array) . "<br>\n";
                    ...
                    echo "</p>\n<p>" . zen_image_submit('button_preview.gif',
                            IMAGE_PREVIEW) . '&nbsp;&nbsp;<a href="' . zen_href_link(FILENAME_CATEGORIES) . '">' . zen_image_button('button_cancel.gif',
                            IMAGE_CANCEL) . "</a></form></p>\n";//steve validator complains about /p
                    echo '<p>' . TEXT_TIPS . "</p>\n";
                    ?>
...
// echo 'I SEE: ' . $copy_as . '<br>' . 'Copy from: ' . $category_id . '<br>' . 'Copy To: ' . $copy_to . '<br><br><br>';
                                                ...
                                                if ($show_product == true) {
                                                    ...
                                                    <tr class="dataTableRow" onmouseover="rowOverEffect(this)"
                                                        ...
                                                        <td class="dataTableContent" align="center">
                                                                ...
                                                                echo '<a href="' . zen_href_link('categories', 'cPath=' . zen_get_product_path($product_multi->fields['products_id']) . '&amp;product_type=1&amp;pID=' . $product_multi->fields['products_id'] . '&amp;action=new_product') . '" target="_blank">' . ($product_multi->fields['products_status'] == '1'? zen_image(DIR_WS_IMAGES . 'icon_green_on.gif', IMAGE_ICON_STATUS_ON .  ' -> Edit Product') : zen_image(DIR_WS_IMAGES . 'icon_red_on.gif', IMAGE_ICON_STATUS_OFF .  ' -> Edit Product')) . '</a>';
                                                                ?>
                                                            </td>
                                                        <td class="dataTableContent" align="center">
                                                                <?php
                                        ...
                                        echo zen_draw_input_field('retry', BUTTON_RETRY, 'alt="' . BUTTON_RETRY . '"',
                                            false, 'submit');
                                        echo '&nbsp;&nbsp;<a href="' . zen_href_link(FILENAME_CATEGORIES) . '">' . zen_image_button('button_cancel.gif',
                                                IMAGE_CANCEL) . "</a></form>\n";
                                        ?>
                                    </td>
                                </tr>
